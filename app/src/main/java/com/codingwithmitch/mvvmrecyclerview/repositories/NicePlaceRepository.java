...
public class NicePlaceRepository {
    ...
    //Web servisten veya online kaynaktan veri alıyormuş gibi veri koyuyoruz.
    public MutableLiveData<List<NicePlace>> getNicePlaces(){
        setNicePlaces();//dataset arrayine bazı veriler yerleştirdik
        MutableLiveData<List<NicePlace>> data = new MutableLiveData<>();
        data.setValue(dataSet);//elimizdeki listeyi mutablelivedata listesine attık
        return data;
    }
